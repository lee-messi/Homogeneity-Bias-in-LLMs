...
for (k in black_males){
  bm.embeddings <- textEmbed(k$text, layers = -3, keep_token_embeddings = FALSE)
...
for (i in black_females){
  bf.embeddings <- textEmbed(i$text, layers = -3, keep_token_embeddings = FALSE)
...
for (i in asian_males){
  am.embeddings <- textEmbed(i$text, layers = -3, keep_token_embeddings = FALSE)
...
for (i in asian_females){
  af.embeddings <- textEmbed(i$text, layers = -3, keep_token_embeddings = FALSE)
...
for (i in hispanic_males){
  hm.embeddings <- textEmbed(i$text, layers = -3, keep_token_embeddings = FALSE)
...
for (i in hispanic_females){
  hf.embeddings <- textEmbed(i$text, layers = -3, keep_token_embeddings = FALSE)
...
for (i in white_males){
  wm.embeddings <- textEmbed(i$text, layers = -3, keep_token_embeddings = FALSE)
...
for (i in white_females){
  wf.embeddings <- textEmbed(i$text, layers = -3, keep_token_embeddings = FALSE)
