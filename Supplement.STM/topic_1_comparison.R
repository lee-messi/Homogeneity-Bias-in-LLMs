...
gender_list <- c(rep("Man", length(unlist(bmc, recursive = FALSE))), 
                 rep("Woman", length(unlist(bfc, recursive = FALSE))),
                 rep("Man", length(unlist(amc, recursive = FALSE))), 
                 rep("Woman", length(unlist(afc, recursive = FALSE))),
                 rep("Man", length(unlist(hmc, recursive = FALSE))), 
                 rep("Woman", length(unlist(hfc, recursive = FALSE))),
                 rep("Man", length(unlist(wmc, recursive = FALSE))), 
                 rep("Woman", length(unlist(wfc, recursive = FALSE))))
